...
<div class="container">
    <div class="card shadow p-3 mb-5 bg-body rounded"> <!-- Updated width and max-width -->
        <div class="title-container mb-3">
            <strong style="font-size: 36px; font-weight: bold;">CAT</strong>
            <a href="panda.php?gameID=<?php echo $gameID; ?>"> <!-- Anchor tag to navigate to tiger.php with gameID -->
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6"> <!-- Column for image -->
                    <img src="cat.jpg" class="img-fluid mb-4">
                </div>
...
<script type="text/javascript">
    ...
    document.getElementById('listen').addEventListener('click', () => {
        speakAndDisplay("Please Repeat After Me CAT");
    });
    ...
    recognition.addEventListener('result', (event) => {
        ...
        if (result.toLowerCase() === "cat") {
            ...
            xhr.open("POST", `insert_resultcat.php?gameID=<?php echo $gameID; ?>`, true);
            ...
            // Redirect to the next page after a delay
setTimeout(() => {
    window.location.href = 'panda.php?gameID=<?php echo $gameID; ?>';
}, 2000);
