...
<nav class="navbar navbar-expand-lg">
  ...
  <div class="container">
    ...
    <a href="water.php"> <!-- Anchor tag to navigate to panda.php -->
      ...
      <div class="card-body">
        ...
        <div class="text-center mb-3">
          <strong style="font-size: 36px; font-weight: bold;">BANANA</strong>
        </div>
        <img src="banana.jpg" class="img-fluid mb-3">
