...
<nav class="navbar navbar-expand-lg">
    ...
    <a href="apple.php"> <!-- Anchor tag to navigate to panda.php -->
      ...
      <div class="card-body">
        ...
        <div class="text-center mb-3">
          <strong style="font-size: 36px; font-weight: bold;">ORANGE</strong>
        </div>
        <img src="orange.jpg" class="img-fluid mb-3">
  ...
  <script type="text/javascript">
    ...
    recognition.addEventListener('result', (event) => {
      ...
      if (result.toLowerCase() === "orange") {
        setTimeout(() => {
          window.location.href = 'apple.php';
        }, 2000);
