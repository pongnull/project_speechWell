...
<nav class="navbar navbar-expand-lg">
  ...
  <div class="container">
    ...
    <a href="mango.php"> <!-- Anchor tag to navigate to panda.php -->
      ...
      <div class="card-body">
        ...
        <div class="text-center mb-3">
          <strong style="font-size: 36px; font-weight: bold;">APPLE</strong>
        </div>
        <img src="apple.jpg" class="img-fluid mb-3">
  ...
  <script type="text/javascript">
    ...
    recognition.addEventListener('result', (event) => {
      ...
      if (result.toLowerCase() === "apple") {
        setTimeout(() => {
          window.location.href = 'mango.php';
        }, 2000);
