...
<div class="container">
    <div class="card shadow p-3 mb-5 bg-body rounded"> <!-- Updated width and max-width -->
        <div class="title-container mb-3">
            <strong style="font-size: 36px; font-weight: bold;">PANDA</strong>
            <a href="tiger.php?gameID=<?php echo $gameID; ?>"> <!-- Anchor tag to navigate to tiger.php with gameID -->
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6"> <!-- Column for image -->
                    <img src="panda.jpg" class="img-fluid mb-4">
                </div>
...
<script type="text/javascript">
    ...
    document.getElementById('listen').addEventListener('click', () => {
        speakAndDisplay("Please Repeat After Me PANDA");
    });
    ...
    recognition.addEventListener('result', (event) => {
        ...
        if (result.toLowerCase() === "panda") {
            // Send the result to the PHP script using AJAX
            var xhr = new XMLHttpRequest();
            xhr.open("POST", `insert_resultpanda.php?gameID=<?php echo $gameID; ?>`, true);
            ...
            // Redirect to the next page after a delay
setTimeout(() => {
    window.location.href = 'tiger.php?gameID=<?php echo $gameID; ?>';
}, 2000);
