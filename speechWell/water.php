...
<body>
  <div class="container">
    ...
    <a href="result.php"> <!-- Anchor tag to navigate to panda.php -->
      ...
      <div class="card-body">
        ...
        <div class="text-center mb-3">
          <strong style="font-size: 36px; font-weight: bold;">WATERMELON</strong>
        </div>
        <img src="water.jpg" class="img-fluid mb-3">
  ...
  <script type="text/javascript">
    ...
    startButton.addEventListener('click', () => { 
      ...
      speak("Repeat After Me watermelon");
      recognition.start(); 
    });
    recognition.addEventListener('result', (event) => {
      ...
      if (result.toLowerCase() === "watermelon") {
        setTimeout(() => {
